class RosaryPrayerService {
  ...
  Map<String, Object> getPrayer() {
    ...
    if (step["type"] == "mystere") {
      ...
      step["count"] = mystere["count"]!;
      step["mystere"] = mystere["mystere"]!;
